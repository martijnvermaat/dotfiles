...
alias res-mon-app01='ssh -t res-mon-app01 "screen -Rd default && clear"'
...
alias res-vard-db01='ssh -t res-vard-db01 "screen -Rd default && clear"'
alias res-vard-db02='ssh -t res-vard-db02 "screen -Rd default && clear"'
alias res-trans-app01='ssh -t res-trans-app01 "screen -Rd default && clear"'
alias res-ssh-alg01='ssh res-ssh-alg01'
alias hg-git01='ssh -t hg-git01 "screen -Rd default && clear"'
alias dmz-web02='ssh -t dmz-web02 "screen -Rd default && clear"'
...
alias rp3dasha='ssh -t rp3dasha "screen -Rd default && clear"'
